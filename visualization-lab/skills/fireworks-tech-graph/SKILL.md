...
**QiaoJi override:** when the project is QiaoJi, use `../../references/qiaoji-default-style.md` as the semantic style preset and map its tokens into the chosen style family instead of relying only on the generic style-1 palette.
