...
"""
content3 = content3.replace('.hot-case { background: #ffffff; border: 1px dashed #cbd5e1; padding: 8px 12px; border-radius: 4px; font-size: 11px; color: var(--text-sub); }\n        .hot-case b { color: #111827; }', css_style)
...
prompt_example = """</div>
            ...
            <div class="hot-case">"""
content3 = re.sub(r'</div>\s*</div>\s*<div class="hot-case">', prompt_example, content3, count=1)

# Insert Agent Example
agent_example = """</div>
            ...
            <div class="hot-case">"""
content3 = re.sub(r'</div>\s*</div>\s*<div class="hot-case">', agent_example, content3, count=1)
...
content4 = content4.replace('.hot-case { background: #ffffff; border: 1px dashed #cbd5e1; padding: 8px 12px; border-radius: 4px; font-size: 11px; color: var(--text-sub); }\n        .hot-case b { color: #111827; }', css_style)
...
workflow_example = """</div>
            ...
            <div class="hot-case">"""
content4 = re.sub(r'</div>\s*</div>\s*<div class="hot-case">', workflow_example, content4, count=1)
...
mcp_example = """</div>
            ...
            <div class="hot-case">"""
content4 = re.sub(r'</div>\s*</div>\s*<div class="hot-case">', mcp_example, content4, count=1)
